...
"""
Graphics Scene - Custom QGraphicsScene for component visualization
"""
...
class ComponentDiagramScene(QGraphicsScene):
    ...
    def _layout_components_grid(self, components: List[Component]):
        ...
        for i, component in enumerate(components):
            ...
            comp_item.mouseDoubleClickEvent = lambda event, c=component: self._on_component_double_clicked(c)
...
# Save as: src/arxml_viewer/gui/graphics/graphics_scene.py